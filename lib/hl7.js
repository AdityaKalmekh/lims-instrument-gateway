 ...
 * @param {{ barcodeLocation?: string, barcodeFallbacks?: string[] }} [opts]
 */
  ...
  const results = parsed.segments
    ...
    .map((obx) => {
      ...
      return {
        ...
        code: component(identifier, 1, parsed.compSep), // e.g. "WBC"
        text: component(identifier, 2, parsed.compSep), // e.g. "White Blood Cell"
        value: field(obx, 5),
